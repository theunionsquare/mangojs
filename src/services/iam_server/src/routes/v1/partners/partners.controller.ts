...
export class PartnerController {
    ...
    public async getPartners(
        req: Request<undefined, APITYPE.V1.partners.GET.RequestBody>,
        res: Response<APITYPE.V1.partners.GET.ResponseBody>
    ): Promise<Response<APITYPE.V1.partners.GET.ResponseBody>> {
        ...
        try {
            ...
            const apiResponse = {
                ...
                data: partnerUsers,
            } as APITYPE.V1.partners.GET.ResponseBody
    ...
    public async addAdminUser(
        req: Request<undefined, APITYPE.V1.partners.POST.RequestBody>,
        res: Response<APITYPE.V1.partners.POST.ResponseBody>
    ): Promise<Response<APITYPE.V1.partners.POST.ResponseBody>> {
