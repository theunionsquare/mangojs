...
export class GroupsService {
    ...
    public async getAllGroups(filter: any): Promise<{}> {
        ...
        const response = await this._persistenceContext.inTransaction(
            async (em: EntityManager) => {
                const responseArray: Array<APITYPE.V1.groups.ResponseBodyData> = []
    ...
    public async getGroups(userType: Types.entities.AuthUserType): Promise<{}> {
        ...
        const response = await this._persistenceContext.inTransaction(
            async (em: EntityManager) => {
                const responseArray: Array<APITYPE.V1.groups.admin.ResponseBodyData> = []
    ...
    public async postGroup(
        ...
        groupData: APITYPE.V1.groups.ResponseBodyData
    ): Promise<APITYPE.V1.groups.ResponseBodyData> {
        ...
        )) as APITYPE.V1.groups.ResponseBodyData
        return response
    }
}