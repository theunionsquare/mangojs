...
const subscriptionService =
  DefaultContainer.resolve<SubscriptionService>(SubscriptionService);
...
export class SubscriptionController {
  ...
  public async getUserSubscriptions(
    req: Request,
    res: Response
  ): Promise<Response<api.v1.subscriptions.GET.ResponseBody>> {
  ...
  public async createSubscription(
    req: Request<undefined, api.v1.subscriptions.POST.RequestBody>,
    res: Response
  ): Promise<Response<api.v1.subscriptions.POST.ResponseBody>> {
    const logRequest = new utils.LogRequest(res);
    try {
  ...
  public async updateSubscription(
    req: Request<
      api.v1.subscriptions.PUT.Params,
      api.v1.subscriptions.PUT.RequestBody
    >,
    res: Response
  ): Promise<Response<api.v1.subscriptions.PUT.ResponseBody>> {
    const logRequest = new utils.LogRequest(res);
    try {
